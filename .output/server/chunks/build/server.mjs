...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-D2GEbbMx.mjs')
  },
  {
    name: "review-slug",
    path: "/review/:slug()",
    component: () => import('./_slug_-DMJlqleS.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-N_vT0QPi.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BQkuOWtR.mjs'));
